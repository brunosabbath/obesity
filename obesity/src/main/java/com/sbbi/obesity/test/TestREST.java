...
public class TestREST {
	...
	public static void main(String[] args) {
		...
		//String path = "/home/bsilva/Desktop/bread.png";
		String path = "/Users/bruno/Desktop/f.jpg";
		
		//String s = temp.getForObject("http://127.0.0.1:5151/classify?path=" + path, String.class);
		String s = temp.getForObject("http://sbbi-panda.unl.edu:5151/classify?path=/var/www/html/obesity/f.jpg", String.class);
